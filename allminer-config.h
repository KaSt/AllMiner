/* allminer-config.h.  Generated from allminer-config.h.in by configure.  */
/* allminer-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Name of package */
#define PACKAGE "allminer"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT ""

/* Define to the full name of this package. */
#define PACKAGE_NAME "allminer"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "allminer 2.2.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "allminer"
